  ...
  const BlockTowerLogo = ({ size = 80, variant = 'color' }) => {
    ...
    return (
      <svg width={size} height={size} viewBox="0 0 80 80" fill="none">
        {/* Timeline line */}
        <rect x="12" y="12" width="2" height="56" rx="1" fill={variant === 'white' ? 'rgba(255,255,255,0.9)' : 'url(#tl-grad)'}/>
        {/* Blocks */}
    ...
    <div style={{ 
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          {colors.primary.map((color) => (
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: 12, color: textMuted, fontFamily: 'JetBrains Mono, monospace' }}>{color.hex}</p>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
          {colors.categories.map((cat) => (
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: 12, color: textMuted, fontFamily: 'monospace' }}>{cat.hex}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          {colors.status.map((status) => (
            ...
            >
              ...
              <span style={{ fontSize: 11, color: textMuted, fontFamily: 'monospace' }}>{status.hex}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{ 
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div>
            <span style={{ fontSize: 11, color: textMuted, textTransform: 'uppercase', letterSpacing: 1 }}>Display / 32px / Bold</span>
            <p style={{ margin: '4px 0 0', fontSize: 32, fontWeight: 700 }}>Time Blocking Made Simple</p>
          </div>
          <div>
            <span style={{ fontSize: 11, color: textMuted, textTransform: 'uppercase', letterSpacing: 1 }}>H1 / 24px / Bold</span>
            <p style={{ margin: '4px 0 0', fontSize: 24, fontWeight: 700 }}>Your Productivity Dashboard</p>
          </div>
          <div>
            <span style={{ fontSize: 11, color: textMuted, textTransform: 'uppercase', letterSpacing: 1 }}>H2 / 20px / Semibold</span>
            <p style={{ margin: '4px 0 0', fontSize: 20, fontWeight: 600 }}>Today's Schedule</p>
          </div>
          <div>
            <span style={{ fontSize: 11, color: textMuted, textTransform: 'uppercase', letterSpacing: 1 }}>Body / 16px / Regular</span>
            <p style={{ margin: '4px 0 0', fontSize: 16, fontWeight: 400 }}>Plan your day with visual time blocks that integrate with your favorite developer tools.</p>
          </div>
          <div>
            <span style={{ fontSize: 11, color: textMuted, textTransform: 'uppercase', letterSpacing: 1 }}>Mono / JetBrains Mono</span>
            <p style={{ margin: '4px 0 0', fontSize: 14, fontFamily: 'JetBrains Mono, monospace' }}>09:00 - 10:30 · 90 min</p>
          </div>
        </div>
      </section>
        ...
        <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ display: 'flex', gap: 8 }}>
              <span style={{ padding: '4px 12px', backgroundColor: '#10b981', color: '#fff', borderRadius: 12, fontSize: 12, fontWeight: 500 }}>GitHub</span>
              <span style={{ padding: '4px 12px', backgroundColor: '#3b82f6', color: '#fff', borderRadius: 12, fontSize: 12, fontWeight: 500 }}>Jira</span>
              <span style={{ padding: '4px 12px', backgroundColor: '#a855f7', color: '#fff', borderRadius: 12, fontSize: 12, fontWeight: 500 }}>Meeting</span>
            </div>
            <div style={{ display: 'flex', gap: 8 }}>
              <span style={{ padding: '4px 12px', backgroundColor: 'rgba(239,68,68,0.15)', color: '#ef4444', borderRadius: 12, fontSize: 12, fontWeight: 500 }}>Urgent</span>
              <span style={{ 
                padding: '4px 12px', 
                ...
                <span style={{ width: 6, height: 6, backgroundColor: '#6366f1', borderRadius: '50%', animation: 'pulse 1.5s infinite' }}></span>
                Live
              </span>
              <span style={{ padding: '4px 12px', backgroundColor: 'rgba(16,185,129,0.15)', color: '#10b981', borderRadius: 12, fontSize: 12, fontWeight: 500 }}>Done</span>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 8 }}>
              <span style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 13, color: textMuted }}>09:00</span>
              <span style={{ padding: '2px 8px', backgroundColor: '#10b981', color: '#fff', borderRadius: 8, fontSize: 11, fontWeight: 500 }}>GitHub</span>
            </div>
