  ...
  return (
    <div className={`h-screen ${themeStyles.bg} ${themeStyles.text} antialiased overflow-hidden`}>
      ...
      <div className="h-full relative">
        {/* Today Screen */}
        <div className={`absolute inset-0 screen-transition ${activeTab === 'today' ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0 pointer-events-none'}`}>
          <TodayScreen 
            themeStyles={themeStyles} 
            isDark={isDark}
            activeTab={activeTab}
        ...
        {/* Inbox Screen */}
        <div className={`absolute inset-0 screen-transition ${activeTab === 'inbox' ? 'translate-x-0 opacity-100' : activeTab === 'today' ? 'translate-x-full opacity-0 pointer-events-none' : '-translate-x-full opacity-0 pointer-events-none'}`}>
          <InboxScreen 
            themeStyles={themeStyles} 
            isDark={isDark}
          />
        ...
        {/* Stats Screen */}
        <div className={`absolute inset-0 screen-transition ${activeTab === 'stats' ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'}`}>
          <StatsScreen 
            themeStyles={themeStyles} 
            isDark={isDark}
          />
        ...
        {/* Settings Screen */}
        <div className={`absolute inset-0 screen-transition ${activeTab === 'settings' && !subScreen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'}`}>
          <SettingsScreen 
            themeStyles={themeStyles}
            isDark={isDark}
            theme={theme}
        ...
        {/* Profile Screen */}
        <div className={`absolute inset-0 screen-transition ${subScreen === 'profile' ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'}`}>
          <ProfileScreen 
            themeStyles={themeStyles}
            isDark={isDark}
            onBack={() => setSubScreen(null)}
            onLogout={() => { setSubScreen(null); setIsAuthenticated(false); }}
          />
        </div>

        {/* Integrations Screen */}
        <div className={`absolute inset-0 screen-transition ${subScreen === 'integrations' ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'}`}>
          <IntegrationsScreen 
            themeStyles={themeStyles}
            isDark={isDark}
            onBack={() => setSubScreen(null)}
      ...
      {/* Loading Screen */}
      {isLoading && (
        <LoadingScreen themeStyles={themeStyles} isDark={isDark} />
      )}
    </div>
  );
};
  ...
  return (
    <div className={`min-h-screen ${themeStyles.bg} ${themeStyles.text} antialiased flex flex-col`}>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[600px] ${isDark ? 'bg-indigo-600/15' : 'bg-indigo-500/10'} rounded-full blur-[120px]`} />
        <div className={`absolute -bottom-40 -right-40 w-[400px] h-[400px] ${isDark ? 'bg-purple-600/10' : 'bg-purple-500/5'} rounded-full blur-[100px]`} />
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 relative">
        ...
        {/* Sign Up Form */}
        <div className={`${themeStyles.cardBg} rounded-3xl border ${themeStyles.border} p-6 ${!isDark ? 'shadow-xl shadow-slate-200/50' : ''}`}>
          <div className="space-y-4">
            {/* Name */}
            <div>
              <label className={`block text-sm font-medium mb-2 ${themeStyles.textMuted}`}>Full Name</label>
              <input
                type="text"
                value={name}
            ...
            {/* Email */}
            <div>
              <label className={`block text-sm font-medium mb-2 ${themeStyles.textMuted}`}>Email</label>
              <input
                type="email"
                value={email}
            ...
            {/* Password */}
            <div>
              <label className={`block text-sm font-medium mb-2 ${themeStyles.textMuted}`}>Password</label>
              ...
              <p className={`text-xs ${themeStyles.textFaint} mt-2`}>Must be at least 8 characters</p>
            </div>
          ...
          <p className={`text-xs text-center ${themeStyles.textFaint} mt-4`}>
            ...
            <button className="text-indigo-500">Terms</button> and{' '}
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 relative">
        ...
        {sent ? (
          ...
          <>
            ...
            <button onClick={onBack} className={`text-center mt-6 ${themeStyles.textMuted} flex items-center justify-center gap-2`}>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" />
              </svg>
              Back to Sign in
    ...
    <div className={`min-h-screen ${themeStyles.bg} ${themeStyles.text} antialiased flex flex-col`}>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 relative">
        ...
        <div className={`${themeStyles.cardBg} rounded-3xl border ${themeStyles.border} p-6 ${!isDark ? 'shadow-xl shadow-slate-200/50' : ''}`}>
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <div className={`absolute right-4 top-1/2 -translate-y-1/2 ${themeStyles.textFaint}`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                  </svg>
                </div>
            ...
            <div className="text-right">
              <button type="button" onClick={onForgot} className="text-sm text-indigo-500 hover:text-indigo-400 font-medium transition-colors">
                Forgot password?
              </button>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className={`px-4 ${themeStyles.cardBg} ${themeStyles.textFaint}`}>or continue with</span>
            </div>
          </div>

          {/* Social Login */}
          <div className="grid grid-cols-2 gap-3">
            <button className={`flex items-center justify-center gap-2 py-3 rounded-xl border ${themeStyles.border} ${themeStyles.hover} font-medium transition-all btn-press`}>
        ...
        <p className={`text-center mt-8 ${themeStyles.textMuted}`}>
          ...
          <button onClick={onSignUp} className="text-indigo-500 hover:text-indigo-400 font-semibold transition-colors">
            Sign up
          </button>
        </p>
      </div>
...
// TODAY SCREEN
// ============================================
const TodayScreen = ({ themeStyles, isDark, activeTab, setActiveTab, reduceMotion, onSelectTask }) => {
  const [currentDate, setCurrentDate] = useState(new Date(2026, 0, 29));
  const [expandedTaskId, setExpandedTaskId] = useState(null);
  const [headerExpanded, setHeaderExpanded] = useState(false);
  const [draggedId, setDraggedId] = useState(null);
  const [tasks, setTasks] = useState([
    { id: 1, title: 'Morning standup', subtitle: 'Engineering Team · Daily sync', time: '09:00', endTime: '09:15', type: 'meeting', completed: true },
    { id: 2, title: 'Review authentication PR', subtitle: 'auth-module #234 · +180 -42', time: '09:30', endTime: '10:15', type: 'github', completed: true },
    { id: 3, title: 'Sprint Planning', subtitle: 'Engineering Team · 5 attendees', time: '10:30', endTime: '11:30', type: 'meeting', elapsed: '32:15', progress: 54, isNow: true },
    { id: 4, title: 'User settings implementation', subtitle: 'JIRA-892 · 5 story points', time: '13:00', endTime: '15:00', type: 'jira' },
    { id: 5, title: 'Code review session', subtitle: 'Review PRs from team', time: '15:30', endTime: '16:30', type: 'github', urgent: true },
    { id: 6, title: 'API documentation update', subtitle: 'JIRA-901 · 2 story points', time: '17:00', endTime: '18:00', type: 'jira' },
  ]);
  ...
  const getDaysCenteredOnToday = () => {
    ...
    for (let i = -3; i <= 3; i++) {
      ...
      days.push({ label: dayLabels[date.getDay()], num: date.getDate(), isToday: i === 0, offset: i });
    }
    return days;
  };
      ...
      if (!reduceMotion) {
        setTimeout(() => {
          ...
          if (element && scrollRef.current) {
            ...
            const scrollTo = element.offsetTop - container.offsetTop - (container.clientHeight / 2) + (element.offsetHeight / 2);
  ...
  return (
    <div className="h-full flex flex-col pb-20">
      {/* Ambient gradient */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className={`absolute -top-40 left-1/2 -translate-x-1/2 w-[600px] h-[600px] ${isDark ? 'bg-indigo-600/8' : 'bg-indigo-500/10'} rounded-full blur-[120px]`} />
      </div>
      ...
      >
        <div className="px-5 pt-8 pb-3">
          <header className="flex items-start justify-between">
            <div>
              ...
              <p className={`text-[11px] ${themeStyles.textFaint} mt-0.5`}>{tasks.length} tasks · {tasks.filter(t => t.completed).length} done</p>
            </div>
            <div className="flex items-center gap-2">
              <div className={`transition-transform duration-300 ${headerExpanded ? 'rotate-180' : ''}`}>
                <svg width="16" height="16" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24" className={themeStyles.textFaint}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                </svg>
              </div>
              <button className="relative" onClick={(e) => e.stopPropagation()}>
                <div className={`w-9 h-9 rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-xs font-semibold text-white ring-2 ${isDark ? 'ring-slate-800' : 'ring-white shadow-md'}`}>
                  SA
                </div>
                <span className={`absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-500 rounded-full border-2 ${isDark ? 'border-slate-950' : 'border-white'}`} />
              </button>
            </div>
          </header>
        </div>
        ...
        {/* Day Selector */}
        <div className={`overflow-hidden transition-all duration-300 ease-in-out ${headerExpanded ? 'max-h-20 opacity-100 pb-4' : 'max-h-0 opacity-0'}`}>
          <div className="flex items-center justify-center gap-1.5 px-5">
            {days.map((day, i) => {
              ...
              return (
                <button
                  key={i}
                  onClick={(e) => { e.stopPropagation(); navigateDay(day.offset); }}
                ...
                >
                  <span className={`font-semibold ${style.textSize} ${day.isToday ? 'text-white' : ''}`}>{day.num}</span>
                  {day.isToday && <span className="text-[8px] text-indigo-200 font-medium -mt-0.5">{day.label}</span>}
                </button>
              );
            })}
          </div>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto hide-scrollbar px-5 pt-4 pb-4">
        <div className="space-y-2.5">
          {tasks.map((task, index) => {
            ...
            return (
              ...
              >
                {isExpanded && <div className="absolute inset-0 rounded-2xl bg-indigo-500/5 focus-pulse" />}
                <div className={`absolute left-0 top-3 w-1 rounded-full ${isCompleted ? (isDark ? 'bg-slate-700' : 'bg-slate-300') : config.borderColor}`} style={{ height: `${getTimeBlockHeight(duration)}px` }} />
                
                <div className="relative p-3.5">
                  <div className="flex items-start gap-3 pl-3">
                    <div className="w-12 flex-shrink-0 pt-0.5">
                      <span className={`text-sm font-mono font-medium ${isCompleted ? themeStyles.textFaint : ''}`}>{task.time}</span>
                      <span className={`block text-[10px] font-mono ${themeStyles.textFaint}`}>{duration}m</span>
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 mb-1 flex-wrap">
                        <span className={`inline-flex items-center gap-1 text-[11px] font-medium px-1.5 py-0.5 rounded ${isCompleted ? `${themeStyles.inputBg} ${themeStyles.textFaint}` : `${config.bgColor} ${config.textColor}`}`}>
                          {config.icon}{config.label}
                        </span>
                        {task.urgent && !isCompleted && <span className={`text-[11px] font-medium px-1.5 py-0.5 rounded ${isDark ? 'bg-red-500/15 text-red-400' : 'bg-red-100 text-red-600'}`}>Urgent</span>}
                        {isCurrent && !isCompleted && (
                          <span className={`inline-flex items-center gap-1 text-[11px] font-medium px-1.5 py-0.5 rounded now-badge ${isDark ? 'bg-indigo-500/20 text-indigo-400' : 'bg-indigo-100 text-indigo-600'}`}>
                            <span className={`w-1.5 h-1.5 rounded-full ${isDark ? 'bg-indigo-400' : 'bg-indigo-500'}`} />Live
                          </span>
                        )}
                        {isCompleted && <span className={`text-[11px] font-medium px-1.5 py-0.5 rounded ${isDark ? 'bg-emerald-500/10 text-emerald-500' : 'bg-emerald-100 text-emerald-600'}`}>Done</span>}
                      </div>
                      <h3 
                    ...
                    {isCompleted ? (
                      ...
                      <button onClick={(e) => e.stopPropagation()} className={`w-6 h-6 rounded-full flex-shrink-0 flex items-center justify-center transition-all ${isExpanded ? 'bg-emerald-600 text-white' : `border ${themeStyles.border} ${themeStyles.textFaint} hover:border-indigo-500 hover:text-indigo-400`}`}>
                  ...
                  {isExpanded && !isCompleted && (
                    <div className={`mt-3 pt-3 border-t ${themeStyles.borderSubtle} pl-3`}>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <span className="text-xl font-mono font-bold">{task.elapsed || '00:00'}</span>
                          <span className={`text-xs ${themeStyles.textFaint}`}>elapsed</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                          <button onClick={(e) => e.stopPropagation()} className={`w-8 h-8 rounded-lg ${themeStyles.inputBg} ${themeStyles.hover} flex items-center justify-center ${themeStyles.textMuted} btn-press`}>
                            {Icons.pause}
                          </button>
                          <button onClick={(e) => e.stopPropagation()} className="px-3 h-8 rounded-lg bg-emerald-600 hover:bg-emerald-500 flex items-center justify-center text-white text-xs font-medium btn-press gap-1">
                            {Icons.check}Done
                          </button>
                        </div>
                      </div>
                      {task.progress !== undefined && (
                        <div className="mt-2.5">
                          <div className={`h-1 ${themeStyles.inputBg} rounded-full overflow-hidden`}>
                            <div className="h-full rounded-full progress-shimmer" style={{ width: `${task.progress}%` }} />
                          </div>
                        </div>
                      )}
                    </div>
        ...
        <button className={`w-full mt-3 mb-4 py-3 rounded-xl border border-dashed ${themeStyles.border} ${themeStyles.textFaint} text-sm font-medium ${themeStyles.hover} btn-press`}>
          + Add time block
        </button>
      </div>
    </div>
...
const InboxScreen = ({ themeStyles, isDark }) => {
  ...
  const inboxItems = [
    { id: 1, title: 'Review Q4 Planning Doc', source: 'google-drive', time: '2h ago', type: 'task' },
    { id: 2, title: 'JIRA-923: Fix login redirect', source: 'jira', time: '3h ago', type: 'task', priority: 'high' },
    { id: 3, title: 'Team standup moved to 10am', source: 'calendar', time: '5h ago', type: 'update' },
  ...
  return (
    <div className="h-full flex flex-col pb-20">
      {/* Header */}
      <div className={`flex-shrink-0 ${themeStyles.cardBgSubtle} backdrop-blur-xl border-b ${themeStyles.borderSubtle}`}>
        <div className="px-5 pt-8 pb-4">
          <h1 className="text-2xl font-bold">Inbox</h1>
          <p className={`text-sm ${themeStyles.textMuted} mt-1`}>Tasks and updates from your integrations</p>
        </div>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 pt-4">
        <div className="space-y-2">
          {inboxItems
            .filter(item => filter === 'all' || (filter === 'tasks' && item.type === 'task') || (filter === 'updates' && item.type !== 'task'))
            .map((item) => (
            <div
              key={item.id}
            ...
            >
              {/* Source icon */}
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ${sourceColors[item.source]}`}>
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                <button className={`w-8 h-8 rounded-lg ${themeStyles.hover} flex items-center justify-center ${themeStyles.textMuted}`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                  </svg>
                </button>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 pt-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} p-4`}>
            ...
            <p className="text-3xl font-bold mt-1">37.1<span className="text-lg font-normal">h</span></p>
          ...
          <div className="flex items-end justify-between gap-2 h-32">
            {weekData.map((day, i) => (
              <div key={day.day} className="flex-1 flex flex-col items-center gap-2">
                ...
                <span className={`text-xs ${i === 3 ? 'text-indigo-400 font-semibold' : themeStyles.textFaint}`}>
                  {day.day}
                </span>
              </div>
            ))}
          ...
          <div className="space-y-3">
            {categoryBreakdown.map((cat) => (
              <div key={cat.name}>
                ...
                <div className={`h-2 rounded-full ${isDark ? 'bg-slate-800' : 'bg-slate-100'} overflow-hidden`}>
                  <div 
        ...
        <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} p-4`}>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className={`text-sm ${themeStyles.textMuted} mt-0.5`}>Based on deep work time and task completion</p>
            </div>
          </div>
        </div>
      </div>
...
// SETTINGS SCREEN
// ============================================
const SettingsScreen = ({ themeStyles, isDark, theme, setTheme, highContrast, setHighContrast, reduceMotion, setReduceMotion, textSize, setTextSize, onBack, onLogout, onProfile, onIntegrations }) => {
  return (
    <div className="h-full flex flex-col">
      {/* Header */}
      <header className={`sticky top-0 z-10 ${themeStyles.cardBgSubtle} backdrop-blur-xl border-b ${themeStyles.borderSubtle}`}>
        <div className="px-5 py-4 flex items-center gap-4">
          <button onClick={onBack} className={`p-2 -ml-2 rounded-xl ${themeStyles.hover} btn-press`}>
            {Icons.back}
          </button>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 py-6 space-y-6 pb-20">
        {/* Appearance */}
        <section>
          <h2 className={`text-xs font-semibold uppercase tracking-wider ${themeStyles.textMuted} mb-3 px-1`}>Appearance</h2>
          <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} overflow-hidden`}>
            <div className="p-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className={`w-9 h-9 rounded-xl ${themeStyles.inputBg} flex items-center justify-center ${themeStyles.textMuted}`}>
                    {theme === 'light' ? Icons.sun : theme === 'dark' ? Icons.moon : Icons.system}
                  </div>
                  <div>
                    <p className="font-medium">Theme</p>
                    <p className={`text-sm ${themeStyles.textMuted}`}>Choose your preferred theme</p>
                  </div>
                </div>
              </div>
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 flex flex-col items-center gap-2 py-3 px-2 rounded-xl border-2 transition-all btn-press ${
                      theme === option.id ? 'border-indigo-500 bg-indigo-500/10' : `${themeStyles.border} ${themeStyles.hover}`
                    }`}
                  >
                    <span className={theme === option.id ? 'text-indigo-400' : themeStyles.textMuted}>{option.icon}</span>
                    <span className={`text-sm font-medium ${theme === option.id ? 'text-indigo-400' : ''}`}>{option.label}</span>
                  </button>
                ))}
              </div>
            </div>
        ...
        {/* Accessibility */}
        <section>
          <h2 className={`text-xs font-semibold uppercase tracking-wider ${themeStyles.textMuted} mb-3 px-1`}>Accessibility</h2>
          <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} overflow-hidden`}>
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-xl ${themeStyles.inputBg} flex items-center justify-center ${themeStyles.textMuted}`}>{Icons.contrast}</div>
                <div>
                  <p className="font-medium">High Contrast</p>
                  <p className={`text-sm ${themeStyles.textMuted}`}>Increase text and UI contrast</p>
                </div>
              </div>
            ...
            <div className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-xl ${themeStyles.inputBg} flex items-center justify-center ${themeStyles.textMuted}`}>{Icons.motion}</div>
                <div>
            ...
            <div className="p-4">
              <div className="flex items-center gap-3 mb-4">
                <div className={`w-9 h-9 rounded-xl ${themeStyles.inputBg} flex items-center justify-center ${themeStyles.textMuted}`}>{Icons.text}</div>
                <div>
        ...
        {/* Account */}
        <section>
          <h2 className={`text-xs font-semibold uppercase tracking-wider ${themeStyles.textMuted} mb-3 px-1`}>Account</h2>
          <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} overflow-hidden`}>
            <SettingsRow icon={Icons.user} label="Profile" sublabel="Manage your account" themeStyles={themeStyles} isFirst onClick={onProfile} />
            <SettingsRow icon={Icons.bell} label="Notifications" sublabel="Alerts and sounds" themeStyles={themeStyles} />
            <SettingsRow icon={Icons.calendar} label="Calendar Sync" sublabel="Google, Outlook" themeStyles={themeStyles} />
            <SettingsRow icon={Icons.link} label="Integrations" sublabel="GitHub, Jira, Slack" themeStyles={themeStyles} isLast onClick={onIntegrations} />
          </div>
        </section>

        {/* Support */}
        <section>
          <h2 className={`text-xs font-semibold uppercase tracking-wider ${themeStyles.textMuted} mb-3 px-1`}>Support</h2>
          <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} overflow-hidden`}>
            <SettingsRow icon={Icons.help} label="Help Center" sublabel="FAQs and guides" themeStyles={themeStyles} isFirst />
            <SettingsRow icon={Icons.shield} label="Privacy" sublabel="Data and permissions" themeStyles={themeStyles} isLast />
          </div>
        </section>
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 py-6 space-y-6">
        ...
        <div className="flex flex-col items-center">
          <div className="relative">
            ...
            <button className={`absolute bottom-0 right-0 w-8 h-8 rounded-full ${themeStyles.cardBg} border ${themeStyles.border} flex items-center justify-center shadow-lg`}>
        ...
        <section>
          <div className="flex items-center justify-between mb-3 px-1">
            <h2 className={`text-xs font-semibold uppercase tracking-wider ${themeStyles.textMuted}`}>Personal Info</h2>
            <button 
        ...
        {/* Stats Summary */}
        <section>
          <h2 className={`text-xs font-semibold uppercase tracking-wider ${themeStyles.textMuted} mb-3 px-1`}>Activity</h2>
          <div className="grid grid-cols-3 gap-3">
            <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} p-4 text-center`}>
        ...
        <section>
          ...
          <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} overflow-hidden`}>
            ...
            <button className={`w-full p-4 flex items-center justify-between border-t ${themeStyles.borderSubtle} ${themeStyles.hover}`}>
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-xl ${themeStyles.inputBg} flex items-center justify-center ${themeStyles.textMuted}`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        <section className="pb-8">
          <h2 className={`text-xs font-semibold uppercase tracking-wider ${themeStyles.textMuted} mb-3 px-1`}>Danger Zone</h2>
          <div className={`${themeStyles.cardBg} rounded-2xl border ${isDark ? 'border-red-500/30' : 'border-red-200'} overflow-hidden`}>
            <button 
              onClick={onLogout}
              className="w-full p-4 flex items-center gap-3 text-red-500"
            >
              <div className={`w-9 h-9 rounded-xl ${isDark ? 'bg-red-500/15' : 'bg-red-50'} flex items-center justify-center`}>
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
            ...
            <button className={`w-full p-4 flex items-center gap-3 text-red-500 border-t ${isDark ? 'border-red-500/30' : 'border-red-200'}`}>
              <div className={`w-9 h-9 rounded-xl ${isDark ? 'bg-red-500/15' : 'bg-red-50'} flex items-center justify-center`}>
                <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
          ...
          <path fill="#ECB22E" d="M8.834 6.313a2.527 2.527 0 0 1 2.521 2.521 2.527 2.527 0 0 1-2.521 2.521H2.522A2.528 2.528 0 0 1 0 8.834a2.528 2.528 0 0 1 2.522-2.521h6.312z"/>
        </svg>
      ),
      color: 'text-pink-500',
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
          ...
          <path d="M20.693 12a8.693 8.693 0 1 1-17.386 0 8.693 8.693 0 0 1 17.386 0z" fillOpacity="0.4"/>
        </svg>
      ),
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-5 py-6 space-y-4">
        ...
        <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} p-4 mt-6`}>
          ...
          <div className="flex gap-2">
            ...
            />
            <button className={`px-4 py-2 rounded-lg ${themeStyles.inputBg} ${themeStyles.textMuted} font-medium text-sm`}>
              Copy
            </button>
          </div>
        </div>
...
const Toggle = ({ enabled, onChange }) => (
  ...
  >
    <span className={`absolute top-1 left-1 w-5 h-5 bg-white rounded-full shadow-sm toggle-knob ${enabled ? 'translate-x-5' : 'translate-x-0'}`} />
  </button>
);

const SettingsRow = ({ icon, label, sublabel, themeStyles, isFirst, isLast, onClick }) => (
  <button onClick={onClick} className={`w-full p-4 flex items-center justify-between transition-opacity hover:opacity-80 active:opacity-60 btn-press ${isFirst ? 'rounded-t-2xl' : ''} ${isLast ? 'rounded-b-2xl' : ''}`}>
    <div className="flex items-center gap-3">
      <div className={`w-9 h-9 rounded-xl ${themeStyles.inputBg} flex items-center justify-center ${themeStyles.textMuted}`}>{icon}</div>
...
const BottomNav = ({ activeTab, setActiveTab, themeStyles, isDark, onAddClick }) => (
  <nav className={`absolute bottom-0 left-0 right-0 ${themeStyles.cardBgSubtle} backdrop-blur-xl border-t ${themeStyles.borderSubtle}`}>
    <div className="max-w-lg mx-auto px-4 py-2 pb-7 flex items-center justify-around">
      <NavItem icon={Icons.calendar} label="Today" active={activeTab === 'today'} onClick={() => setActiveTab('today')} />
      <NavItem icon={Icons.inbox} label="Inbox" badge={5} active={activeTab === 'inbox'} onClick={() => setActiveTab('inbox')} />
      ...
      <NavItem icon={Icons.chartBar} label="Stats" active={activeTab === 'stats'} onClick={() => setActiveTab('stats')} />
      <NavItem icon={Icons.cog} label="Settings" active={activeTab === 'settings'} onClick={() => setActiveTab('settings')} />
    </div>
  </nav>
);

const NavItem = ({ icon, label, active, badge, onClick }) => (
  <button onClick={onClick} className={`flex flex-col items-center gap-1 btn-press ${active ? 'text-indigo-400' : 'text-slate-500 hover:text-slate-300'}`}>
    <div className={`relative h-6 flex items-center justify-center transition-transform ${active ? 'scale-110' : ''}`}>
      {icon}
      {badge && <span className="absolute -top-1 -right-2.5 w-4 h-4 bg-red-500 rounded-full text-[9px] font-bold flex items-center justify-center text-white">{badge}</span>}
    </div>
...
const AddTaskModal = ({ themeStyles, isDark, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      {/* Modal */}
      <div className={`relative w-full max-w-lg ${themeStyles.cardBg} rounded-t-3xl border-t ${themeStyles.border} p-6 pb-10 animate-slide-up`}>
        {/* Handle */}
        ...
        {/* Task Title */}
        <div className="mb-4">
          <label className={`block text-sm font-medium mb-2 ${themeStyles.textMuted}`}>What are you working on?</label>
          <input
            type="text"
            value={title}
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div>
            <label className={`block text-sm font-medium mb-2 ${themeStyles.textMuted}`}>Start Time</label>
            <input
              type="time"
              value={startTime}
          ...
          <div>
            <label className={`block text-sm font-medium mb-2 ${themeStyles.textMuted}`}>Duration</label>
            <select
              value={duration}
        ...
        {/* Task Type */}
        <div className="mb-6">
          <label className={`block text-sm font-medium mb-2 ${themeStyles.textMuted}`}>Category</label>
          <div className="flex gap-2">
            {taskTypes.map((type) => (
              <button
                key={type.id}
...
const TaskDetailModal = ({ task, themeStyles, isDark, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className={`relative w-full max-w-md ${themeStyles.cardBg} rounded-3xl border ${themeStyles.border} overflow-hidden animate-scale-in`}>
        {/* Header with color */}
        ...
        <div className="p-6">
          ...
          <div className={`p-4 rounded-2xl ${themeStyles.inputBg} mb-6`}>
            ...
            {task.progress !== undefined && (
              <div className={`mt-3 h-2 rounded-full ${isDark ? 'bg-slate-700' : 'bg-slate-200'} overflow-hidden`}>
                <div className={`h-full rounded-full ${config.solid}`} style={{ width: `${task.progress}%` }} />
              </div>
            )}
          </div>
          ...
          <div className="flex gap-3">
            {!task.completed && (
              <>
                <button className={`flex-1 py-3 rounded-xl ${themeStyles.inputBg} font-medium ${themeStyles.textMuted} flex items-center justify-center gap-2`}>
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            {task.completed && (
              <button className={`w-full py-3 rounded-xl ${themeStyles.inputBg} font-medium ${themeStyles.textMuted}`}>
                Reopen Task
              </button>
            )}
          </div>
...
const LoadingScreen = ({ themeStyles, isDark }) => (
  <div className={`fixed inset-0 z-[100] ${themeStyles.bg} flex flex-col items-center justify-center`}>
    <style>{`
    ...
    {/* Loading bar */}
    <div className={`w-32 h-1 rounded-full ${isDark ? 'bg-slate-800' : 'bg-slate-200'} overflow-hidden`}>
...
const EmptyState = ({ icon, title, description, action, actionLabel, themeStyles, isDark }) => (
  <div className="flex flex-col items-center justify-center py-16 px-8 text-center">
    <div className={`w-16 h-16 rounded-2xl ${isDark ? 'bg-slate-800' : 'bg-slate-100'} flex items-center justify-center mb-4 ${themeStyles.textMuted}`}>
      {icon}
    </div>
...
const SkeletonCard = ({ themeStyles, isDark }) => (
  <div className={`${themeStyles.cardBg} rounded-2xl border ${themeStyles.border} p-4 animate-pulse`}>
