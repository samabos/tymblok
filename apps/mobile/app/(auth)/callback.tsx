  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: themeColors.bg }}>
      <View className="flex-1 items-center justify-center p-6">
        {error ? (
          <>
            <View className="w-16 h-16 rounded-full items-center justify-center mb-4" style={{ backgroundColor: colors.status.urgent + '20' }}>
              <Text className="text-3xl">!</Text>
            </View>
            <Text className="text-xl font-semibold text-center mb-2" style={{ color: themeColors.text }}>
